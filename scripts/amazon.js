...
loadProducts(renderProductsGrid); // In JS, finctions are values and we can use a function as a parameter. The function renderProductsGrid is known as a callback. because we are giving it a function to run in the future. 
